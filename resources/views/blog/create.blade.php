<x-app-layout>
          ...
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
            <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="w-full">
                  ...
                  <trix-editor input="content" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 my-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"></trix-editor>
  ...
  document.addEventListener('trix-file-accept', function(e) {
    e.preventDefault(); // Prevent default file handling by Trix

    var file = e.file;
    var form = new FormData();
    form.append('image_blog', file); // Change 'image' to 'image_blog'
    ...
    .then(data => {
        // Insert the uploaded image into the Trix editor
        var editor = document.querySelector('trix-editor');
        editor.editor.insertHTML(`<img src="${data.url}" alt="Uploaded Image">`);
    })
