  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
              <div class="p-5">
                  <a href="{{ route('portofolio.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Produk</a>
                  <table class="table-auto w-full mt-5">
                      <tr>
                          <th class="border px-4 py-2" width="30%">Foto Produk</th>
                          <th class="border px-4 py-2" width="20%">Title Produk</th>
                          <th class="border px-4 py-2" width="20%">Sub Title Produk</th>
